/******/ (() => { // webpackBootstrap
  ...
  /******/ 	var __webpack_modules__ = ({
    ...
    /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      var noteS = document.createTextNode("Paper");
      option.append(noteS);
      var option1 = document.createElement("option");
      var noteS1 = document.createTextNode("Scissors");
      option1.append(noteS1);
      var option2 = document.createElement("option");
      var noteS2 = document.createTextNode("Rock");
      ...
      body.append(h2); //zaidimo pradzia

      var computerSelection = "";
      var playerSelection = "";
      h2.innerText = "Beat me";
      button.addEventListener("click", function () {
        h2.innerText = (0,_function__WEBPACK_IMPORTED_MODULE_0__.computerPlay)();
        computerSelection = h2.innerText;
        playerSelection = select1.value;
        (0,_function__WEBPACK_IMPORTED_MODULE_0__.playRound)(playerSelection, computerSelection);
      });
    ...
    /***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
      ...
      function computerPlay() {
        var gameOper = ["Rock", "Paper", "Scissors"];
        return gameOper[rand(0, 3)];
      }
      function playRound(playerSelection, computerSelection) {
        if (playerSelection == "Rock" && computerSelection == "Scissors" || playerSelection == "Scissors" && computerSelection == "Paper" || playerSelection == "Paper" && computerSelection == "Rock") {
          _app__WEBPACK_IMPORTED_MODULE_0__.div.style.backgroundImage = "url(https://t4.ftcdn.net/jpg/04/03/11/17/240_F_403111774_OsxWERa4NWZJPzqElkwSKR3nnRhp4UEI.jpg)";
          ...
          _app__WEBPACK_IMPORTED_MODULE_0__.div.style.backgroundImage = "url(https://t3.ftcdn.net/jpg/02/84/65/12/240_F_284651274_TodDY90ZPQaVSuOaBLTRhPjw8AP3ib61.jpg)";
        } else {
          _app__WEBPACK_IMPORTED_MODULE_0__.div.style.backgroundImage = "url(https://t3.ftcdn.net/jpg/02/77/12/58/240_F_277125895_7iX39NWuBb9kyBwAxTOUpZQNIY4HiAwf.jpg)";
        }
      }
